...
public class HitBoxes
    ...
    public HitBoxes() {
        super(ChatColor.RED + "HitBoxes", 18);
        int total = 0;
        ...
        for (Check.CheckType type : Check.CheckType.values()) {
            if (type.getName().contains("HitBoxes")) {
    ...
    public void onClick(ClickData clickData) {
        ...
        if (slot <= this.getInventory().getSize() && slot >= 0) {
            ...
            } else if (clickData.getClickType().isLeftClick() && checkStack.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.RED + ChatColor.BOLD.toString() + type.getName())) {
            ...
            } else if (clickData.getClickType().isRightClick() && checkStack.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.RED + ChatColor.BOLD.toString() + type.getName())) {
                clickData.getPlayer().closeInventory();
