...
public class Liscence {
    ...
    public Liscence(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public Liscence setSecurityKey(String securityKey) {
    ...
    public boolean register() {
        ...
        if (vt == ValidationType.VALID) {
            log("[FBI] License is valid, loading FBI...");
            return true;
        } else {
            log("[FBI] License isn't valid, disabling FBI!");
