...
public class AutoClickerX
    ...
    public AutoClickerX() {
        super(Check.CheckType.AUTO_CLICKERX, "X", "AutoClicker", Check.CheckVersion.RELEASE);
        this.violations = -1.0;
    }
                ...
                if (this.flyingCount < 10) {
                    ...
                    if (++this.clicks == 20) {
                        if (this.outliers == 0) {
                            ...
                            this.buffer = buffer;
                            if (buffer >= 8.0) {
                                VL.getInstance().handleViolation(playerData, this, "F " + this.flyingCount, false);
                            }
                            VL.getInstance().handleDebug(playerData, this, "F " + this.flyingCount);
                        } else {
