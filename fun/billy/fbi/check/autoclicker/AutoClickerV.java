...
public class AutoClickerV
    ...
    public AutoClickerV() {
        super(CheckType.AUTO_CLICKERV, "V", "AutoClicker", CheckVersion.RELEASE);
        this.violations = -1.0;
    }
                ...
                if (this.flyingCount < 10) {
                    ...
                    if (++this.clicks == 40) {
                        if (this.outliers == 0) {
                            ...
                            this.buffer = buffer;
                            if (buffer >= 7.0) {
                                VL.getInstance().handleViolation(playerData, this, "VAPE LITE ", false);
                            }
                            VL.getInstance().handleDebug(playerData, this, "B " + buffer);
                        } else {
